...
# -*- coding: utf-8 -*-
"""
Batch Gender Bias Scoring using Qwen-VL API
Instagram Post Analysis System
"""
...
class BatchGenderBiasScorer:
    def __init__(self):
        """
        Batch processing for gender bias scoring using sample data in current directory
        """
...
def main():
    ...
    """
    processor = BatchGenderBiasScorer()
    processor.run()
